<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="buivh_InClass20240409._default" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:ListBox ID="lbFruits" runat="server" CssClass="ListBoxCssClass" OnSelectedIndexChanged="lbFruits_SelectedIndexChanged" Height="191px" AutoPostBack="True" DataSourceID="sqlDataSourceInClass20240409" DataTextField="LastName" DataValueField="NameID">
